...
2. **Створили сценарій бота** (`bot.js`):
   ...
   - Задали *статичні змінні* для користувача, друзів, NFT і транзакцій.  
...
3. **Перевірили роботу бота**:  
   ...
   - При натискані на "Play" з'являється інтерфейс програми: 
     ...
     ![image1ForLabs4](./docs/image1Lab4.png)
     ![image2ForLabs4](./docs/image2Lab4.png)
     ![image3ForLabs4](./docs/image3Lab4.png)
     ![image4ForLabs4](./docs/image4Lab4.png)
     ![image5ForLabs4](./docs/image5Lab4.png)
