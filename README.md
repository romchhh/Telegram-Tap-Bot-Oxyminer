...
- **Сценарій:** Користувач купує NFT за 50 балів.
  - **Таблиця `nft`:** Додається запис:
    ...
    ```
  - **Таблиця `users`:** Поле `points` оновлюється на -50.

---

### **Висновок**

Розроблено структуру проекту, визначено основні модулі, їх взаємодію та сценарії оновлення даних. Це дозволить ефективно реалізувати бізнес-логіку та спростити підтримку додатка.
